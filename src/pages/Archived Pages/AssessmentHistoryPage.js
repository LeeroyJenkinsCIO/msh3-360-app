...
const AssessmentHistoryPage = ({ currentUserId, currentUser, onNavigate, onLogout }) => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto py-8 px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Published 360° assessments with MSH IDs</p>
        </div>
        ...
        {assessments.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Published Assessments</h3>
            <p className="text-gray-600 mb-6">
              Published assessments will appear here with their MSH IDs
            </p>
          </div>
        ) : (
                  ...
                  {assessments.map((assessment) => {
                    ...
                    return (
                      <tr key={assessment.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">
                          <button 
                            onClick={() => onNavigate('comparison', { sessionId: assessment.sessionId })}
